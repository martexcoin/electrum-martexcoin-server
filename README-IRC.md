...
current list can be seen by running:
    ...
    electrum-martexcoin-server peers
...
`electrum-martexcoin-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-martexcoin.
